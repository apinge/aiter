...
def chunk_gated_delta_rule_fwd_opt_vk(
    ...
    Args:
        ...
        initial_state: optional [N, H, V, K] — note transposed h layout.
            If initial_state_indices is provided, initial_state is a state pool
            [pool_size, H, V, K] and K5 reads/writes indexed slots in place.
        initial_state_indices: optional [N] pool slot ids.
        output_final_state: bool
